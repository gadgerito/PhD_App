...
<div id="bat-signal">
    <svg viewBox="0 0 200 200" xmlns="http://www.w3.org/2000/svg">
        <!-- Oval background -->
        <ellipse cx="100" cy="100" rx="95" ry="75" fill="#1a1a1a"/>
        <!-- Classic Batman logo bat -->
        <path d="M100,55
            C100,55 88,42 70,48 C55,53 42,65 38,78
            C46,72 56,73 62,79
            C56,83 48,92 47,103
            C54,93 64,91 71,94 L77,108
            C81,116 86,122 100,122
            C114,122 119,116 123,108 L129,94
            C136,91 146,93 153,103
            C152,92 144,83 138,79
            C144,73 154,72 162,78
            C158,65 145,53 130,48
            C112,42 100,55 100,55 Z"
            fill="#f1c40f"/>
    </svg>
</div>
